...
const PREFERENCES_STRINGS = {
    ...
    BLOCK_LOCATIONS: {
        ...
        "ja-jp": "これらのサイトなら Flash コンテンツ読込むことを抑止",
        "zh-tw": "封鎖包含這些網址的 Flash 外掛模組",
        "zh-cn": "永远停用这些地址的 Flash 插件"
    },
    BLOCK_SOURCES: {
        "en-us": "Block Flash from these sources",
        "fr-fr": "Bloquer le Flash provenant de ",
        "es-es": "Bloquear el contenido Flash en los archivos",
        "ja-jp": "これらのソースなら Flash コンテンツ読み込むことを抑止",
        "zh-tw": "封鎖這些來源的 Flash 外掛模組",
        "zh-cn": "永远停用这些来源的 Flash 插件"
    },
    INVERT_WHITELISTS: {
        "en-us": "Negate lists",
        "fr-fr": "Inverser",
    ...
    DEBUG_MODE: {
        ...
        "ja-jp": "Flash コンテンツを手動的に抑止する",
        "zh-tw": "手動封鎖 Flash 外掛模組",
        "zh-cn": "手动封锁 Flash 插件"
    },
    SHOW_TOOLTIP: {
...
const GLOBAL_STRINGS = {
    ...
    ALWAYS_BLOCK_ON_DOMAIN: {
        ...
        "ja-jp": "このドメインなら Flash コンテンツを抑止",
        "zh-tw": "封鎖包含這個域名的 Flash 外掛模組",
        "zh-cn": "停用这个域名的 Flash 插件"
    },
    ALWAYS_ALLOW_SOURCE: {
        "en-us": "Always Allow",
        "fr-fr": "Toujours autoriser",
