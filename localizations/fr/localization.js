...
const TURN_CTF_ON = "Activer ClickToFlash";
const TURN_CTF_OFF = "Désactiver ClickToFlash";
...
// Dialogs
const ADD_TO_LOC_WHITELIST_DIALOG = "Autoriser Flash si l'adresse de la page contient";
const ADD_TO_LOC_BLACKLIST_DIALOG = "Bloquer Flash si l'adresse de la page contient";
const ADD_TO_SRC_WHITELIST_DIALOG = "Autoriser les éléments Flash provenant de";
