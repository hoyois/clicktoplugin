...
const PLUGIN_GENERIC = "Дополнение";

// Contextual menu items
const LOAD_ALL_PLUGINS = "Подгрузить все Дополнения";
...
const VIEW_ON_SITE = function(site) {return "Посмотреть на " + site;};

// Dialogs
const QT_CONFIRM_LAUNCH_DIALOG = function(url) {return "Объект QuickTime предлагает показать\n\n" + url + "\n\nв проигрывателе QuickTime. Позволить это сделать?";};
const ADD_TO_LOC_WHITELIST_DIALOG = "Показывать дополнения встроенные в страницы с адресом вида:";
